...
class PreviewPanel(QWidget):
    def __init__(self):
        ...
        self.cbo_editor = QComboBox()
        self.cbo_editor.setObjectName("editorChoice")
        self.cbo_editor.addItem("Novo editor QML", "qml")
        self.cbo_editor.addItem("Editor legado", "legacy")
        self.cbo_editor.setAccessibleName("Editor para criar e editar modelos")
        self.cbo_editor.setToolTip("Escolha o editor usado pelos botões Novo e Editar.")
        self.cbo_editor.setMinimumHeight(30)
        layout.addWidget(self.cbo_editor)
